...
public class Main2Activity_nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 6,  Multiplicaciones  ", Toast.LENGTH_SHORT).show();
    ...
    public void numAleatorio(int score){
        ...
        if (score <=18){//Aqui fin del juego puedes colocar 100000 ó 100
            ...
            Toast.makeText(this, "Ganaste, superaste todas las etapas", Toast.LENGTH_SHORT).show();
    ...
    public void getScore( int score, int tipo){
        ...
        Cursor consultaScore = BasesDeDatos.rawQuery( "SELECT * FROM t_puntaje as a WHERE a.nomJugador = '"+nombre_jugador+"'", null );
