...
public class AdmiSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    // Tabla de Preguntas -TANDA CAT. COMIDA - NIVEL BASICO -
        ...
        //  BasesDeDatos.execSQL("INSERT INTO t_preguntas (id, co_categoria, co_nivel, co_respuesta, pregunta, respuesta, enlace_resp, imagen_pre, imagen_resp, activo) VALUES (20, 1, 2, 20, '¿ Cuantos museos hay en México ?', 'El territorio nacional existen mas de 300 mil museos', 'https://www.eluniversal.com.mx/cultura/en-mexico-existen-mil-300-museos', '0', '0', 1), (21, 1, 2, 21, '¿ Cuántos museos hay en la CDMX ?', '155 según la secretaria de la cultura', '0', '0', '0', 1) , (22, 1, 2, 22, 'La Plaza de la Constitución Zócalo recibe su nombre en honor a ¿ Cuál constitución ?', 'La Constitución de Cádiz de 1812', '0', '0', '0', 1) , (23, 1, 2, 23, '¿ Las posadas son fiestas privadas o vecinales que se realizan: ?', 'Los días previos a la Navidad ', '0', '0', '0', 1) , (24, 1, 2, 24, '¿ Es costumbre cantar Las golondrinas para: ?', 'Despedir a alguien ', '0', '0', '0', 1)");
        //  BasesDeDatos.execSQL("INSERT INTO t_preguntas (id, co_categoria, co_nivel, co_respuesta, pregunta, respuesta, enlace_resp, imagen_pre, imagen_resp, activo) VALUES         (25, 1, 2, 25, '¿ En los cumpleaños se suele cantar en homenaje al festejado:?', 'Las mañanitas', '0', '0', '0', 1)  , (26, 1, 2, 26, '¿ Principales puertos turísticos ?', 'Cozumel, Acapulco, Mazatlán', '0', '0', '0', 1)  , (27, 1, 2, 27, '  Los Pinos en la capital de México es el nombre de: ', 'La residencia oficial del presidente de la República, Hasta el 2018 ', '0', '0', '0', 1)  , (28, 1, 2, 28, '¿ Versos festivos que se escriben en noviembre con motivo del Día de muertos ?', 'Calaveras o Calaveritas', '0', '0', '0', 1)  , (29, 1, 2, 29, '¿ Quién ganó el Premio Nobel de Química por haber identificado las propiedades químicas que debilitan la capa de ozono?', 'Mario José Molina Henríquez', '0', '0', '0', 1)");
